 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,t,i,s){const a=t[0];if("."===a){return new P(e,t.slice(1),i).parts}if("@"===a)return[new M(e,t.slice(1),s.eventContext)];if("?"===a)return[new x(e,t.slice(1),i)];return new k(e,t,i).parts}handleTextExpression(e){return new C(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const H=(e,...t)=>new w(e,t,"html",D)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
      ...
      <div class="card-config">
        ...
        ${Ve.actions.show?H`
              <div class="values">
                ...
                ${Ve.actions.options.hold.show?H`
                      <div class="values">
                        <paper-item>Action Editors Coming Soon</paper-item>
                      </div>
                    `:""}
                ...
                ${Ve.actions.options.double_tap.show?H`
                      <div class="values">
                        <paper-item>Action Editors Coming Soon</paper-item>
                      </div>
                    `:""}
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const He=new WeakMap;String(Math.random()).slice(2),window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:e=>e});
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
let Oe=!1;(()=>{try{const e={get capture(){return Oe=!0,!1}};window.addEventListener("test",e,e),window.removeEventListener("test",e,e)}catch(e){}})(),
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */console.info(`%c  MAILANDPACKAGES-CARD \n%c  ${ze("common.version")} 0.7.2.7    `,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"mailandpackages-card",name:"mailandpackages Card",preview:!0,description:"A template custom card for you to create something awesome"});let je=class extends ie{static async getConfigElement(){return document.createElement("mailandpackages-card-editor")}static getStubConfig(){return{name:"Mail and Packages"}}setConfig(e){if(!e)throw new Error(ze("common.invalid_configuration"));e.test_gui&&function(){var e=document.querySelector("home-assistant");if(e=(e=(e=(e=(e=(e=(e=(e=e&&e.shadowRoot)&&e.querySelector("home-assistant-main"))&&e.shadowRoot)&&e.querySelector("app-drawer-layout partial-panel-resolver"))&&e.shadowRoot||e)&&e.querySelector("ha-panel-lovelace"))&&e.shadowRoot)&&e.querySelector("hui-root")){var t=e.lovelace;return t.current_view=e.___curView,t}return null}().setEditMode(!0),this.config=Object.assign({title:"Mail and Packages"},e)}shouldUpdate(e){return!!this.config&&function(e,t,i){if(t.has("config")||i)return!0;if(e.config.entity){var s=t.get("hass");return!s||s.states[e.config.entity]!==e.hass.states[e.config.entity]}return!1}(this,e,!1)}render(){const e=this.hass.states["sensor.mail_updated"].state?H`Last Check: ${this.hass.states["sensor.mail_updated"].state}`:"",t=this.config.entity_usps_mail?H`<div><a href="https://informeddelivery.usps.com/" title="Open the USPS Informed Delivery website." target="_blank"><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_mail.png" /></a> ${this.hass.states["sensor.mail_usps_mail"].state}</div>`:"",i=this.hass.states["camera.mail_usps_camera"].attributes.entity_picture,s=this.config.entity_packages_in_transit?H`<div><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_in-transit.png" /> ${this.hass.states["sensor.mail_packages_in_transit"].state} </div>`:"",a=this.config.entity_packages_delivered?H`<div><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_delivery.png" /> ${this.hass.states["sensor.mail_packages_delivered"].state} </div>`:"",n=this.config.amazon_url?this.config.amazon_url:"",o=this.config.entity_amazon_packages?H`<div><a href="${n}" title="Open the amazon website." target="_blank"><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_amazon.png" /></a> ${this.hass.states["sensor.mail_amazon_packages"].state}</div>`:"",r=this.config.entity_amazon_packages_delivered?H`<div><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_delivery.png" /> ${this.hass.states["sensor.mail_amazon_packages_delivered"].state}</div>`:"",c=this.config.entity_amazon_hub_packages?H`<div><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_amazon-hub.png" /> ${this.hass.states["sensor.mail_amazon_hub_packages"].state}</div>`:"",l=this.hass.states["camera.mail_amazon_delivery_camera"].attributes.entity_picture,d=this.config.entity_fedex_packages?H`<div><a href="$https://www.fedex.com/apps/fedextracking" title="Open the FedEx website." target="_blank"><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_fedex.png" /></a> ${this.hass.states["sensor.mail_fedex_packages"].state}</div>`:"",h=this.config.entity_UPS_packages?H`<div><a href="$https://wwwapps.ups.com/mcdp" title="Open the UPS website." target="_blank"><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_ups.png" /></a> ${this.hass.states["sensor.mail_ups_packages"].state}</div>`:"",p=this.config.entity_USPS_packages?H`<div><a href="https://informeddelivery.usps.com/" title="Open the USPS Informed Delivery website." target="_blank"><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_usps.png" /></a> ${this.hass.states["sensor.mail_usps_packages"].state}</div>`:"",u=this.config.entity_USPS_exceptions?H`<div><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_usps.png" /> ${this.hass.states["sensor.mail_usps_exception"].state}</div>`:"",g=this.config.entity_canada_post_packages?H`<div><a href="https://www.canadapost-postescanada.ca" title="Open the Canada Post website." target="_blank"><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_canada-post.png" /></a> ${this.hass.states["sensor.mail_canada_post_packages"].state}</div>`:"",_=this.config.entity_DHL_packages?H`<div><a href="https://www.dhl.com" title="Open the DHL website." target="_blank"><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_dhl.png" /></a> ${this.hass.states["sensor.mail_dhl_packages"].state}</div>`:"",m=this.config.entity_hermes_packages?H`<div><a href="https://www.myhermes.co.uk" title="Open the Hermes  website." target="_blank"><img src="/hacsfiles/img/square_hermes-packages.png" /></a> ${this.hass.states["sensor.mail_hermes_packages"].state}</div>`:"",f=this.config.entity_royal_mail_packages?H`<div><a href="https://www.royalmail.com" title="Open the Royal Mail website." target="_blank"><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_royal-mail.png" /></a> ${this.hass.states["sensor.mail_royal_mail_packages"].state}</div>`:"",v=this.config.entity_delivery_message?this.hass.states[this.config.entity_delivery_message].state:"";if(this.config.show_warning)return this._showWarning(ze("common.show_warning"));return!this.hass.states["sensor.mail_updated"].state?this._showError(ze("common.show_error")):H`
      <ha-card
        tabindex="0"
      ...
      ${this.config.show_usps_camera?H`
      <img @action=${this._handleAction}
        .actionHandler=${Re({hasHold:Pe(this.config.hold_action),hasDoubleClick:Pe(this.config.double_tap_action)})} class="MailImg clear" src="${i}&interval=30" />
      `:""}
      ...
      <!-- ${o||r||c||this.config.show_amazon_camera?H`<h1>Amazon</h1>`:""} -->
      <div class="amazon">
      ${o}
      ${r}
      ${c}
      </div>
      ${this.config.show_amazon_camera?H`
      <img class="MailImg clear" src="${l}&interval=30" />
      `:""}
      <div class="footer">
      <span class="usps_update">${e}</span> <span class="version">v${"0.7.2.7"}</span></div>

      </ha-card>
    `}_handleAction(e){this.hass&&this.config&&e.detail.action&&xe(this,this.hass,this.config,e.detail.action)}_showWarning(e){return H`
      <hui-warning>${e}</hui-warning>
    `}_showError(e){const t=document.createElement("hui-error-card");return t.setConfig({type:"error",error:e,origConfig:this.config}),H`
      ${t}
