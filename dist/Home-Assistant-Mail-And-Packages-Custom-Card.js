 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */console.info(`%c  MAILANDPACKAGES-CARD \n%c  ${ze("common.version")} 0.7.2.4    `,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"mailandpackages-card",name:"mailandpackages Card",preview:!0,description:"A template custom card for you to create something awesome"});let je=class extends ie{static async getConfigElement(){return document.createElement("mailandpackages-card-editor")}static getStubConfig(){return{name:"Mail and Packages"}}setConfig(e){if(!e)throw new Error(ze("common.invalid_configuration"));e.test_gui&&function(){var e=document.querySelector("home-assistant");if(e=(e=(e=(e=(e=(e=(e=(e=e&&e.shadowRoot)&&e.querySelector("home-assistant-main"))&&e.shadowRoot)&&e.querySelector("app-drawer-layout partial-panel-resolver"))&&e.shadowRoot||e)&&e.querySelector("ha-panel-lovelace"))&&e.shadowRoot)&&e.querySelector("hui-root")){var t=e.lovelace;return t.current_view=e.___curView,t}return null}().setEditMode(!0),this.config=Object.assign({title:"Mail and Packages"},e)}shouldUpdate(e){return!!this.config&&function(e,t,i){if(t.has("config")||i)return!0;if(e.config.entity){var s=t.get("hass");return!s||s.states[e.config.entity]!==e.hass.states[e.config.entity]}return!1}(this,e,!1)}render(){const e=this.hass.states["sensor.mail_updated"].state?O`Last Check: ${this.hass.states["sensor.mail_updated"].state}`:"",t=this.config.entity_usps_mail?O`<div><a href="https://informeddelivery.usps.com/" title="Open the USPS Informed Delivery website." target="_blank"><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_mail.png" /></a> ${this.hass.states["sensor.mail_usps_mail"].state}</div>`:"",i=this.hass.states["camera.mail_usps_camera"].attributes.entity_picture,s=this.config.entity_packages_in_transit?O`<div><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_in-transit.png" /> ${this.hass.states["sensor.mail_packages_in_transit"].state} </div>`:"",a=this.config.entity_packages_delivered?O`<div><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_delivery.png" /> ${this.hass.states["sensor.mail_packages_delivered"].state} </div>`:"",n=this.config.amazon_url?this.config.amazon_url:"",o=this.config.entity_amazon_packages?O`<div><a href="${n}" title="Open the amazon website." target="_blank"><img src="/hacsfiles/img/square_amazon.png" /></a> ${this.hass.states["sensor.mail_amazon_packages"].state}</div>`:"",r=this.config.entity_amazon_packages_delivered?O`<div><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_delivery.png" /> ${this.hass.states["sensor.mail_amazon_packages_delivered"].state}</div>`:"",c=this.config.entity_amazon_hub_packages?O`<div><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_amazon-hub.png" /> ${this.hass.states["sensor.mail_amazon_hub_packages"].state}</div>`:"",l=this.hass.states["camera.mail_amazon_delivery_camera"].attributes.entity_picture,d=this.config.entity_fedex_packages?O`<div><a href="$https://www.fedex.com/apps/fedextracking" title="Open the FedEx website." target="_blank"><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_fedex.png" /></a> ${this.hass.states["sensor.mail_fedex_packages"].state}</div>`:"",h=this.config.entity_UPS_packages?O`<div><a href="$https://wwwapps.ups.com/mcdp" title="Open the UPS website." target="_blank"><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_ups.png" /></a> ${this.hass.states["sensor.mail_ups_packages"].state}</div>`:"",p=this.config.entity_USPS_packages?O`<div><a href="https://informeddelivery.usps.com/" title="Open the USPS Informed Delivery website." target="_blank"><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_usps.png" /></a> ${this.hass.states["sensor.mail_usps_packages"].state}</div>`:"",u=this.config.entity_USPS_exceptions?O`<div><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_usps.png" /> ${this.hass.states["sensor.mail_usps_exception"].state}</div>`:"",g=this.config.entity_canada_post_packages?O`<div><a href="https://www.canadapost-postescanada.ca" title="Open the Canada Post website." target="_blank"><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_canada-post.png" /></a> ${this.hass.states["sensor.mail_canada_post_packages"].state}</div>`:"",_=this.config.entity_DHL_packages?O`<div><a href="https://www.dhl.com" title="Open the DHL website." target="_blank"><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_dhl.png" /></a> ${this.hass.states["sensor.mail_dhl_packages"].state}</div>`:"",m=this.config.entity_hermes_packages?O`<div><a href="https://www.myhermes.co.uk" title="Open the Hermes  website." target="_blank"><img src="/hacsfiles/img/square_hermes-packages.png" /></a> ${this.hass.states["sensor.mail_hermes_packages"].state}</div>`:"",f=this.config.entity_royal_mail_packages?O`<div><a href="https://www.royalmail.com" title="Open the Royal Mail website." target="_blank"><img src="/hacsfiles/Home-Assistant-Mail-And-Packages-Custom-Card/img/square_royal-mail.png" /></a> ${this.hass.states["sensor.mail_royal_mail_packages"].state}</div>`:"",v=this.config.entity_delivery_message?this.hass.states[this.config.entity_delivery_message].state:"";if(this.config.show_warning)return this._showWarning(ze("common.show_warning"));return!this.hass.states["sensor.mail_updated"].state?this._showError(ze("common.show_error")):O`
      <ha-card
        tabindex="0"
    ...
    `}_handleAction(e){this.hass&&this.config&&e.detail.action&&xe(this,this.hass,this.config,e.detail.action)}_showWarning(e){return O`
